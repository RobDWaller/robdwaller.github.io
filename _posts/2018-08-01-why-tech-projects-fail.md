...
The reality is if a project costs $100,000 to complete you will pay $100,000 to complete it. If you try to cut corners and only spend $50,000 you'll most likely end up spending more than $100,000 over time as costs accrue. The only way to reduce a budget is to cut the number of requirements until the work can be fully delivered for your budget. 
